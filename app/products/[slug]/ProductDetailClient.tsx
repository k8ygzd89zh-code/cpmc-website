...
const heroImages: Record<string, string> = {
  'aerosol-cans': img('/products/Aerosol Cans.png'),
  'food-cans': img('/products/Food and milk powder Cans.png'),
  'aluminum-cans': img('/products/2-Piece Aluminum Cans.png'),
  'beer-cans': img('/products/beer can.png'),
  'tin-boxes': img('/products/Custom Tin Boxes.png'),
  'metal-caps': img('/products/metal caps.png'),
  'steel-drums': img('/products/steel drums.png'),
  'plastic-packaging': img('/products/plastic pakaging.png'),
  'printing-coating': img('/products/printing&coating.png'),
};
    ...
    <>
      <section ref={heroRef} className="relative min-h-[45vh] flex items-center bg-[#1A1A1A] overflow-hidden pt-20">
        <div className="absolute inset-0 z-0">
          <img
            src={heroImages[slug] || img('/products/Aerosol Cans.png')}
            alt={product.title}
